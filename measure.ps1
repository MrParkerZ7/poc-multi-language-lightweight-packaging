...
$variants = @(
    ...
    @{ Lang = "Java/Kotlin (3-best: GraalVM + epsilon GC + UPX)"  ; Artifact = "java-kotlin/3-best/target/app.exe"                                            },
    ...
    @{ Lang = "C# (3-best: AOT + max-trim + no-stack-trace)"      ; Artifact = "csharp/3-best/publish/app.exe"                                                },
    ...
    @{ Lang = "Python (3-best: PyOxidizer + memory-only modules)" ; Artifact = "python/3-best/build"                                                          },
    ...
    @{ Lang = "Node/TS (3-best: esbuild + QuickJS-NG + UPX)"      ; Artifact = "node/3-best/dist/app.mjs"                                                     },
    ...
    @{ Lang = "Go (3-best: TinyGo + leaking GC + no scheduler)"   ; Artifact = "go/3-best/app.exe"                                                            },
    ...
    @{ Lang = "Rust (3-best: build-std + immediate-abort + UPX)"  ; Artifact = "rust/3-best/target/x86_64-unknown-linux-musl/release/app"                     }
)
