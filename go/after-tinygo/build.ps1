# after-tinygo: TinyGo compiler — alternative Go compiler with much smaller output
...
Write-Host "[after-tinygo] tinygo build -o app.exe -opt=z ." -ForegroundColor Cyan
