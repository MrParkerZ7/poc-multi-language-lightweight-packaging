# 2-amalgamate (Go): TinyGo + opt=z + UPX + scratch container
...
Write-Host "[2-amalgamate] tinygo build -opt=z -no-debug" -ForegroundColor Cyan
...
if ($upx) {
    Write-Host "[2-amalgamate] upx --best --lzma app.exe" -ForegroundColor Cyan
