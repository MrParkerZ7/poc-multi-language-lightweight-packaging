# 1-optimize-tinygo: TinyGo compiler — alternative Go compiler with much smaller output
...
Write-Host "[1-optimize-tinygo] tinygo build -o app.exe -opt=z ." -ForegroundColor Cyan
