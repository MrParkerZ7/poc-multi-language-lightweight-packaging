# 1-optimize-zipapp: zipapp â€” single .pyz, stdlib only, needs Python installed on host
...
Write-Host "[1-optimize-zipapp] python -m zipapp build/ -o dist/app.pyz" -ForegroundColor Cyan
