# 1-after-zipapp: zipapp â€” single .pyz, stdlib only, needs Python installed on host
...
Write-Host "[1-after-zipapp] python -m zipapp build/ -o dist/app.pyz" -ForegroundColor Cyan
