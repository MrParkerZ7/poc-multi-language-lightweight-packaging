# venv-deps-before: venv + installed deps (the typical "ship everything" Python deployment)
$ErrorActionPreference = "Stop"

if (Test-Path .venv) { Remove-Item -Recurse -Force .venv }

Write-Host "[venv-deps-before] python -m venv .venv" -ForegroundColor Cyan
python -m venv .venv

Write-Host "[venv-deps-before] pip install -r requirements.txt" -ForegroundColor Cyan
