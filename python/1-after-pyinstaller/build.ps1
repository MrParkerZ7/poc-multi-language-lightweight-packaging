# 1-after-pyinstaller: PyInstaller onefile â€” bundles a stripped Python interpreter
$ErrorActionPreference = "Stop"

# Make sure pyinstaller is available
$pi = (Get-Command pyinstaller -ErrorAction SilentlyContinue)
if (-not $pi) {
    Write-Host "[1-after-pyinstaller] pip install --quiet pyinstaller" -ForegroundColor Cyan
...
Write-Host "[1-after-pyinstaller] pyinstaller --onefile --strip --noconfirm app.py" -ForegroundColor Cyan
