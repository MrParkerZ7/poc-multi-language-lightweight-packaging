# 0-before-venv-deps: venv + installed deps (the typical "ship everything" Python deployment)
$ErrorActionPreference = "Stop"

if (Test-Path .venv) { Remove-Item -Recurse -Force .venv }

Write-Host "[0-before-venv-deps] python -m venv .venv" -ForegroundColor Cyan
python -m venv .venv

Write-Host "[0-before-venv-deps] pip install -r requirements.txt" -ForegroundColor Cyan
