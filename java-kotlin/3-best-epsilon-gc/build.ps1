$13-best-epsilon-gc (Java/Kotlin): GraalVM native + every 2-amalgamate flag + epsilon GC + UPX (LZMA)
...
Write-Host "[3-best-epsilon-gc] mvn -Pnative clean package -DskipTests" -ForegroundColor Cyan
...
$13-best-epsilon-gc accepts this risk explicitly; for safer profile use 2-amalgamate.
$upx = (Get-Command upx -ErrorAction SilentlyContinue)
if ($upx -and ($IsLinux -or ($env:OS -ne "Windows_NT"))) {
    Write-Host "[3-best-epsilon-gc] upx --best --lzma" -ForegroundColor Cyan
