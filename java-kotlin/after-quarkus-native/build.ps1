# after-quarkus-native: Quarkus native (native-first JVM framework, GraalVM-compiled)
# Requires: GraalVM 21 with native-image (run `gu install native-image`)
$ErrorActionPreference = "Stop"

Write-Host "[after-quarkus-native] mvn -Pnative clean package -DskipTests" -ForegroundColor Cyan
