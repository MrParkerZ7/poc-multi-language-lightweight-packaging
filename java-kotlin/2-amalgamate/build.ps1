# 2-amalgamate (Java/Kotlin): GraalVM native + every safe size knob + scratch container
...
Write-Host "[2-amalgamate] mvn -Pnative clean package -DskipTests" -ForegroundColor Cyan
