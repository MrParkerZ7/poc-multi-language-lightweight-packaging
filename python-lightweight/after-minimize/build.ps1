# after-minimize: zipapp — single .pyz, stdlib only, needs Python installed on host
...
Write-Host "[after-minimize] python -m zipapp build/ -o dist/app.pyz" -ForegroundColor Cyan
