# self-contained-before: self-contained single-file publish
$ErrorActionPreference = "Stop"

Write-Host "[self-contained-before] dotnet publish -c Release -r win-x64 --self-contained" -ForegroundColor Cyan
