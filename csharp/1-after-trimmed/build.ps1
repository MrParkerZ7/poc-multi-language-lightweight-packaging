# 1-after-trimmed: PublishTrimmed (no AOT) — drops unused IL while keeping the JIT runtime
# Middle-ground between self-contained (big, full reflection) and AOT (small, restricted reflection)
$ErrorActionPreference = "Stop"

Write-Host "[1-after-trimmed] dotnet publish -c Release -r win-x64" -ForegroundColor Cyan
