# 0-before-self-contained: self-contained single-file publish
$ErrorActionPreference = "Stop"

Write-Host "[0-before-self-contained] dotnet publish -c Release -r win-x64 --self-contained" -ForegroundColor Cyan
