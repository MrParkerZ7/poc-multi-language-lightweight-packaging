# 0-standard-self-contained: self-contained single-file publish
$ErrorActionPreference = "Stop"

Write-Host "[0-standard-self-contained] dotnet publish -c Release -r win-x64 --self-contained" -ForegroundColor Cyan
dotnet publish -c Release -r win-x64 --self-contained -o publish | Out-Host
