...
$variants = @(
    ...
    @{ Lang = "Java/Kotlin (3-best)"                             ; Tag = "poc-lightweight/java-3-best"               },
    ...
    @{ Lang = "C# (3-best)"                                      ; Tag = "poc-lightweight/csharp-3-best"             },
    ...
    @{ Lang = "Python (3-best)"                                  ; Tag = "poc-lightweight/python-3-best"             },
    ...
    @{ Lang = "Node/TS (3-best)"                                 ; Tag = "poc-lightweight/node-3-best"               },
    ...
    @{ Lang = "Go (3-best)"                                      ; Tag = "poc-lightweight/go-3-best"                 },
    ...
    @{ Lang = "Rust (3-best)"                                    ; Tag = "poc-lightweight/rust-3-best"               }
)
