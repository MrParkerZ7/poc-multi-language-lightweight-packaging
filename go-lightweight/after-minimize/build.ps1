# after-minimize: stripped + UPX-compressed
# Requires: UPX on PATH (https://upx.github.io/)
$ErrorActionPreference = "Stop"

Write-Host "[after-minimize] go build -ldflags='-s -w' -trimpath" -ForegroundColor Cyan
...
if ($upx) {
    Write-Host "[after-minimize] upx --best --lzma app.exe" -ForegroundColor Cyan
