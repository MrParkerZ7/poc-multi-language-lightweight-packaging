...
For Java's `before-spring-boot-fat-jar/` specifically, use **Spring Boot** to add realistic enterprise weight (~25 MB fat JAR for trivial CLI is the typical naive deployment most teams encounter).
